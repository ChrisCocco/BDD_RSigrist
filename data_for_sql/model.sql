...
(
 ...
 `lieu_1`                   varchar(45) NULL COMMENT 'Lieu de travail (ville)' ,
 `lieu_2`                   varchar(45) NULL COMMENT 'Autre lieu de travail (ville)' ,
 `lieu_3`                   varchar(45) NULL COMMENT 'Autre lieu de travail (ville)' ,
 `lieu_4`                   varchar(45) NULL COMMENT 'Autre lieu de travail (ville)' ,
