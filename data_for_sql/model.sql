...
(
 ...
 `prenom`                   varchar(60) NULL COMMENT 'Prénom du savant' ,
 ...
 `naissance_date_comment`   varchar(45) NULL COMMENT 'En cas d’incertitude sur l’année de naissance, quelle est cette incertitude ?' ,
 `mort_date`                smallint NULL COMMENT 'Année de décès' ,
 `mort_date_certitude`      binary(1) NOT NULL COMMENT 'Sommes-nous certains de l’année de décès ?' ,
 `mort_date_comment`        varchar(45) NULL COMMENT 'En cas d’incertitude sur l’année de décès quelle est cette incertitude ?' ,
 `naissance_lieu`           varchar(45) NULL COMMENT 'Lieu de naissance' ,
 `mort_lieu`                varchar(50) NULL COMMENT 'Lieu de décès' ,
 `pays_principal`           varchar(45) NULL COMMENT 'Pays dans lequel le savant a exercé l’essentiel de ses activités' ,
 `pays_2`                   varchar(45) NULL COMMENT 'Autre pays dans lequel a vécu le savant.' ,
 `pays_3`                   varchar(45) NULL COMMENT 'Autre pays dans lequel a vécu le savant.' ,
 `empire`                   varchar(45) NULL COMMENT 'Empire du lieu de vie et du lieu de travail' ,
 `lieu_1`                   varchar(60) NULL COMMENT 'Lieu de travail (ville)' ,
 `lieu_2`                   varchar(60) NULL COMMENT 'Autre lieu de travail (ville)' ,
 `lieu_3`                   varchar(60) NULL COMMENT 'Autre lieu de travail (ville)' ,
 `lieu_4`                   varchar(60) NULL COMMENT 'Autre lieu de travail (ville)' ,
 `discipl_1`                varchar(60) NOT NULL COMMENT 'Discipline scientifique (second niveau)' ,
 `discipl_2`                varchar(45) NULL COMMENT 'Discipline scientifique (second niveau)' ,
 `discipl_3`                varchar(45) NULL COMMENT 'Discipline scientifique (second niveau)' ,
 `discipl_4`                varchar(45) NULL COMMENT 'Discipline scientifique (second niveau)' ,
 `discipl_5`                varchar(45) NULL COMMENT 'Discipline scientifique (second niveau)' ,
 `a_paris`                  varchar(45) NULL COMMENT 'Académie des sciences de Paris (y a appartenu et à quelles dates)' ,
 `a_londres`                varchar(45) NULL COMMENT 'Académie des sciences de Londres (y a appartenu et à quelles dates)' ,
 `a_berlin`                 varchar(45) NULL COMMENT 'Académie des sciences de Berlin (y a appartenu et à quelles dates)' ,
 `a_petersb`                varchar(45) NULL COMMENT 'Académie des sciences de Saint-Pétersbourg (y a appartenu et à quelles dates)' ,
 `a_stockh`                 varchar(45) NULL COMMENT 'Académie des sciences de Stockholm (y a appartenu et à quelles dates)' ,
 `a_bologne`                varchar(45) NULL COMMENT 'Académie des sciences de Bologne y a appartenu et à quelles dates)' ,
 `acad_7`                   varchar(45) NULL COMMENT 'Autre académie des sciences à laquelle le savant a appartenu' ,
 `acad_8`                   varchar(45) NULL COMMENT 'Autre académie des sciences à laquelle le savant a appartenu' ,
 `acad_9`                   varchar(45) NULL COMMENT 'Autre académie des sciences à laquelle le savant a appartenu' ,
 `pos_acad_1`               varchar(45) NULL COMMENT 'Première position académique' ,
 `pos_acad_2`               varchar(45) NULL COMMENT 'Deuxième position académique' ,
 `prix_1`                   varchar(45) NULL COMMENT 'Prix' ,
 `prix_2`                   varchar(45) NULL COMMENT 'Prix' ,
 `nbre_acad`                tinyint unsigned NULL COMMENT 'Nombre d’affiliations académiques' ,
 ...
 `dsb`                      binary(1) NULL COMMENT 'Présent dans le « Dictionary of Scientific Biography » ?' ,
 `macmill`                  binary(1) NULL COMMENT 'Présent dans le « Macmillan Dictionary of the History of Science » (1981) ?' ,
 `id_type_eminence`         tinyint unsigned NOT NULL COMMENT 'Éminence scientifique (1 = AAA ou A++, 2 = AA ou A+, 3 = A ou A-, 4 = B)' ,
 `remarques`                text NULL COMMENT 'Remarques, commentaires' ,
 `source_1`                 varchar(45) NULL COMMENT 'Source de type DSB (pour les A) ou Gasc. (pour les B)' ,
 `source_2`                 varchar(45) NULL COMMENT 'Source de type Poggendorff (ou Linée ou Bernoulli)' ,
 `source_3`                 varchar(45) NULL COMMENT 'Source de type « World Biographical Information System » (WBIS)' ,
 `source_4`                 varchar(45) NULL COMMENT 'Source de type Wikipedia ou internet' ,
 `source_5`                 varchar(45) NULL COMMENT 'Source de type recueils nationaux, bibliographies nationales ou livre sur le savant' ,
 `equipement`               text NULL COMMENT 'Équipements du savant (laboratoires, observatoires, etc.)' ,
