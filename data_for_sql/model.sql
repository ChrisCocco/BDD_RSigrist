...
(
 ...
 `a_petersb`                varchar(60) NULL COMMENT 'Académie des sciences de Saint-Pétersbourg (y a appartenu et à quelles dates)' ,
 ...
 `acad_7`                   varchar(60) NULL COMMENT 'Autre académie des sciences à laquelle le savant a appartenu' ,
 `acad_8`                   varchar(60) NULL COMMENT 'Autre académie des sciences à laquelle le savant a appartenu' ,
 `acad_9`                   varchar(60) NULL COMMENT 'Autre académie des sciences à laquelle le savant a appartenu' ,
 `pos_acad_1`               varchar(80) NULL COMMENT 'Première position académique' ,
 `pos_acad_2`               varchar(80) NULL COMMENT 'Deuxième position académique' ,
