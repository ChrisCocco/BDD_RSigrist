...
(
 ...
 `mort_date_comment`        varchar(45) COMMENT 'En cas d’incertitude sur l’année de décès quelle est cette incertitude ?' ,
 `naissance_lieu`           varchar(45) COMMENT 'Lieu de naissance' ,
 `mort_lieu`                varchar(50) COMMENT 'Lieu de décès' ,
 ...
 `nbre_acad`                tinyint unsigned COMMENT 'Nombre d’affiliations académiques' ,
